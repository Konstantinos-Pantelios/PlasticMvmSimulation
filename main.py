...
plt.annotate("N ", xy=(1.1, 0.2),xycoords='axes fraction',xytext=(1.1, 0.2))
plt.annotate("", xy=(1.1, 0.2), xycoords='axes fraction',xytext=(1.1, 0.1), arrowprops=dict(arrowstyle="->"),annotation_clip=False)
